...
1. From the `/home/ubuntu` directory, download and install the `sgnd` binary:
    ...
    ```sh
    curl -L https://github.com/celer-network/sgn-v2-networks/releases/download/v1.19.7/sgnd-v1.19.7-goleveldb-linux-amd64.tar.gz | tar -xz
    # To use with cleveldb on Ubuntu, download https://github.com/celer-network/sgn-v2-networks/releases/download/v1.19.7/sgnd-v1.19.7-cleveldb-ubuntu-linux-amd64.tar.gz
    mv sgnd $GOBIN
    ```
